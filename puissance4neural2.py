...
class Element(object):
    def __init__(this, tableau = [],tableauBias = []):
        if(len(tableau) == 0):
            tableau = [genElem() for i in range(3936)];
            tableauBias = [genElem() for i in range(71)];
    ...
    def coups(this, dataGrid):
        ...
        return sortie
    def muter(this):
        for i in range(randint(5, 60)):
            this.tableau[randint(0,3936- 1)] = genElem();
            this.tableauBias[randint(0,84 - 1)] = genElem();
